...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAllCourses = async () => {
      try {
        setIsLoading(true);
        const coursesData = await getCourses(); // make sure this handles auth
        setAllCourses(coursesData);
      } catch (error) {
        console.error("Failed to fetch courses:", error);
        setAllCourses([]); // optional fallback
      } finally {
        setIsLoading(false);
      }
    };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-l text-gray-500 mb-8 leading-relaxed">
                ...
                skills, advance your career, and transform your life with our
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-8">
                ...
                <button className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 bg-white text-gray-700 rounded-xl font-semibold shadow-md hover:bg-gray-50 transform hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-4xl font-bold text-gray-900 mb-2 transition-colors duration-300 group-hover:text-white">
                  {stat.value}
                </div>
                <div className="text-lg text-gray-600 transition-colors duration-300 group-hover:text-white">
                  {stat.label}
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our most popular and highly-rated courses from expert
              instructors
            </p>
          </div>
        ...
        <nav className="space-y-2">
          {categories.map((cat) => (
            <Link
              ...
              className="flex items-center p-2 rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900"
            >
              {cat}
            </Link>
          ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4 text-lg">
                Founded in 2023, SkillHunter started with a simple idea: to
                bridge the skills gap in the modern workforce. We believe
                learning is a lifelong journey and are committed to empowering
                individuals to achieve their personal and professional goals.
              </p>
              <p className="text-gray-600 leading-relaxed text-lg">
                We create a platform that not only teaches relevant, in-demand
                skills but also fosters a community of lifelong learners where
                students and instructors connect, share knowledge, and grow
                together.
              </p>
              <Link
                to="/about"
